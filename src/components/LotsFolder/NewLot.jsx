...
import { NewLot as addNewLotService } from '../../services/LotServices/AddLotSrv';

function NewLot({ operationId, onClose, onConfirm }) {
    ...
    // Status panel exactly like NewOperation.jsx status panel
